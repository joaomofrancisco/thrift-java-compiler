...
public class ODSValue implements org.apache.thrift.TBase<ODSValue, ODSValue._Fields>, java.io.Serializable, Cloneable, Comparable<ODSValue> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ODSValue");
  ...
  static {
    schemes.put(StandardScheme.class, new ODSValueStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ODSValueTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ODSValue.class, metaDataMap);
  }
   ...
   */
  public ODSValue(ODSValue other) {
  ...
  public ODSValue deepCopy() {
    return new ODSValue(this);
  }
  ...
  public ODSValue setUnixTime(long unixTime) {
    this.unixTime = unixTime;
    setUnixTimeIsSet(true);
    return this;
  }
  ...
  public ODSValue setValue(double value) {
    this.value = value;
    setValueIsSet(true);
    return this;
  }
  ...
  public ODSValue setApplication(String application) {
    this.application = application;
    return this;
  }
  ...
  public ODSValue setKey(String key) {
    this.key = key;
    return this;
  }
  ...
  public ODSValue setLocation(String location) {
    this.location = location;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ODSValue)
      return this.equals((ODSValue)that);
    return false;
  }

  public boolean equals(ODSValue that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ODSValue other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ODSValue(");
    boolean first = true;
  ...
  private static class ODSValueStandardSchemeFactory implements SchemeFactory {
    public ODSValueStandardScheme getScheme() {
      return new ODSValueStandardScheme();
    }
  }

  private static class ODSValueStandardScheme extends StandardScheme<ODSValue> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ODSValue struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ODSValue struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ODSValueTupleSchemeFactory implements SchemeFactory {
    public ODSValueTupleScheme getScheme() {
      return new ODSValueTupleScheme();
    }
  }

  private static class ODSValueTupleScheme extends TupleScheme<ODSValue> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ODSValue struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ODSValue struct) throws org.apache.thrift.TException {
