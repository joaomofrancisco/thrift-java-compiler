...
public class GetTimeSeriesByAggTypeParams implements org.apache.thrift.TBase<GetTimeSeriesByAggTypeParams, GetTimeSeriesByAggTypeParams._Fields>, java.io.Serializable, Cloneable, Comparable<GetTimeSeriesByAggTypeParams> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetTimeSeriesByAggTypeParams");
  ...
  static {
    schemes.put(StandardScheme.class, new GetTimeSeriesByAggTypeParamsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetTimeSeriesByAggTypeParamsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetTimeSeriesByAggTypeParams.class, metaDataMap);
  }
   ...
   */
  public GetTimeSeriesByAggTypeParams(GetTimeSeriesByAggTypeParams other) {
  ...
  public GetTimeSeriesByAggTypeParams deepCopy() {
    return new GetTimeSeriesByAggTypeParams(this);
  }
  ...
  public GetTimeSeriesByAggTypeParams setEntities(List<String> entities) {
    this.entities = entities;
    return this;
  }
  ...
  public GetTimeSeriesByAggTypeParams setKeys(List<String> keys) {
    this.keys = keys;
    return this;
  }
  ...
  public GetTimeSeriesByAggTypeParams setStartTime(long startTime) {
    this.startTime = startTime;
    setStartTimeIsSet(true);
    return this;
  }
  ...
  public GetTimeSeriesByAggTypeParams setEndTime(long endTime) {
    this.endTime = endTime;
    setEndTimeIsSet(true);
    return this;
  }
   ...
   * @see OdsDataTable
   */
  public GetTimeSeriesByAggTypeParams setTable(OdsDataTable table) {
    this.table = table;
    return this;
  }
  ...
  public GetTimeSeriesByAggTypeParams setWindow(int window) {
    this.window = window;
    setWindowIsSet(true);
    return this;
  }
  ...
  public GetTimeSeriesByAggTypeParams setAggregationTypeBitMap(int aggregationTypeBitMap) {
    this.aggregationTypeBitMap = aggregationTypeBitMap;
    setAggregationTypeBitMapIsSet(true);
    return this;
  }
  ...
  public GetTimeSeriesByAggTypeParams setTraceData(String traceData) {
    this.traceData = traceData;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetTimeSeriesByAggTypeParams)
      return this.equals((GetTimeSeriesByAggTypeParams)that);
    return false;
  }

  public boolean equals(GetTimeSeriesByAggTypeParams that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetTimeSeriesByAggTypeParams other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetTimeSeriesByAggTypeParams(");
    boolean first = true;
  ...
  private static class GetTimeSeriesByAggTypeParamsStandardSchemeFactory implements SchemeFactory {
    public GetTimeSeriesByAggTypeParamsStandardScheme getScheme() {
      return new GetTimeSeriesByAggTypeParamsStandardScheme();
    }
  }

  private static class GetTimeSeriesByAggTypeParamsStandardScheme extends StandardScheme<GetTimeSeriesByAggTypeParams> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetTimeSeriesByAggTypeParams struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.entities = new ArrayList<String>(_list190.size);
                String _elem191;
                for (int _i192 = 0; _i192 < _list190.size; ++_i192)
                {
                  _elem191 = iprot.readString();
                  struct.entities.add(_elem191);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.keys = new ArrayList<String>(_list193.size);
                String _elem194;
                for (int _i195 = 0; _i195 < _list193.size; ++_i195)
                {
                  _elem194 = iprot.readString();
                  struct.keys.add(_elem194);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetTimeSeriesByAggTypeParams struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.entities != null) {
        oprot.writeFieldBegin(ENTITIES_FIELD_DESC);
        {
          ...
          for (String _iter196 : struct.entities)
          {
      ...
      if (struct.keys != null) {
        oprot.writeFieldBegin(KEYS_FIELD_DESC);
        {
          ...
          for (String _iter197 : struct.keys)
          {
  ...
  private static class GetTimeSeriesByAggTypeParamsTupleSchemeFactory implements SchemeFactory {
    public GetTimeSeriesByAggTypeParamsTupleScheme getScheme() {
      return new GetTimeSeriesByAggTypeParamsTupleScheme();
    }
  }

  private static class GetTimeSeriesByAggTypeParamsTupleScheme extends TupleScheme<GetTimeSeriesByAggTypeParams> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetTimeSeriesByAggTypeParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetEntities()) {
        {
          ...
          for (String _iter198 : struct.entities)
          {
      ...
      if (struct.isSetKeys()) {
        {
          ...
          for (String _iter199 : struct.keys)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetTimeSeriesByAggTypeParams struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.entities = new ArrayList<String>(_list200.size);
          String _elem201;
          for (int _i202 = 0; _i202 < _list200.size; ++_i202)
          {
            _elem201 = iprot.readString();
            struct.entities.add(_elem201);
          }
        }
        struct.setEntitiesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.keys = new ArrayList<String>(_list203.size);
          String _elem204;
          for (int _i205 = 0; _i205 < _list203.size; ++_i205)
          {
            _elem204 = iprot.readString();
            struct.keys.add(_elem204);
          }
        }
        struct.setKeysIsSet(true);
      }
