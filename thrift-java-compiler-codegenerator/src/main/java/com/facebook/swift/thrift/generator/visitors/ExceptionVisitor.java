...
import com.facebook.swift.thrift.generator.codegenerator.ExceptionCodeGenerator;
...
public class ExceptionVisitor extends AbstractTemplateVisitor {
	...
	public void visit(final Visitable visitable) throws IOException {
		...
		ExceptionCodeGenerator generator = new ExceptionCodeGenerator();
		generator.setConfig(config);
		generator.setContext(context);
		generator.setCodeModel(codeModel);
		try {
			generator.generete(exception);
		} catch (Exception e) {
