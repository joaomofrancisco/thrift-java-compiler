...
public class TimeValue implements org.apache.thrift.TBase<TimeValue, TimeValue._Fields>, java.io.Serializable, Cloneable, Comparable<TimeValue> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TimeValue");
  ...
  static {
    schemes.put(StandardScheme.class, new TimeValueStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TimeValueTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TimeValue.class, metaDataMap);
  }
  ...
  public TimeValue setUnixTime(long unixTime) {
    this.unixTime = unixTime;
    setUnixTimeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    ...
    if (that instanceof TimeValue)
      return this.equals((TimeValue)that);
    return false;
  }

  public boolean equals(TimeValue that) {
    if (that == null)
      return false;
  ...
  private static class TimeValueStandardSchemeFactory implements SchemeFactory {
    public TimeValueStandardScheme getScheme() {
      return new TimeValueStandardScheme();
    }
  }

  private static class TimeValueStandardScheme extends StandardScheme<TimeValue> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TimeValue struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TimeValue struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TimeValueTupleSchemeFactory implements SchemeFactory {
    public TimeValueTupleScheme getScheme() {
      return new TimeValueTupleScheme();
    }
  }

  private static class TimeValueTupleScheme extends TupleScheme<TimeValue> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TimeValue struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TimeValue struct) throws org.apache.thrift.TException {
