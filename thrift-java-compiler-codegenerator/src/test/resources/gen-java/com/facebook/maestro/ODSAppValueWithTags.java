...
public class ODSAppValueWithTags implements org.apache.thrift.TBase<ODSAppValueWithTags, ODSAppValueWithTags._Fields>, java.io.Serializable, Cloneable, Comparable<ODSAppValueWithTags> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ODSAppValueWithTags");
  ...
  private static final org.apache.thrift.protocol.TField CATEGORY_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("category_id", org.apache.thrift.protocol.TType.I32, (short)7);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new ODSAppValueWithTagsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ODSAppValueWithTagsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ODSAppValueWithTags.class, metaDataMap);
  }
   ...
   */
  public ODSAppValueWithTags(ODSAppValueWithTags other) {
  ...
  public ODSAppValueWithTags deepCopy() {
    return new ODSAppValueWithTags(this);
  }
  ...
  public ODSAppValueWithTags setUnixTime(long unixTime) {
    this.unixTime = unixTime;
    setUnixTimeIsSet(true);
    return this;
  }
  ...
  public ODSAppValueWithTags setValue(double value) {
    this.value = value;
    setValueIsSet(true);
    return this;
  }
  ...
  public ODSAppValueWithTags setEntity(String entity) {
    this.entity = entity;
    return this;
  }
  ...
  public ODSAppValueWithTags setKey(String key) {
    this.key = key;
    return this;
  }
  ...
  public ODSAppValueWithTags setInterval(int interval) {
    this.interval = interval;
    setIntervalIsSet(true);
    return this;
  }
  ...
  public ODSAppValueWithTags setTags(List<AggSettings> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ODSAppValueWithTags setCategory_id(int category_id) {
    this.category_id = category_id;
    setCategory_idIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ODSAppValueWithTags)
      return this.equals((ODSAppValueWithTags)that);
    return false;
  }

  public boolean equals(ODSAppValueWithTags that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ODSAppValueWithTags other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ODSAppValueWithTags(");
    boolean first = true;
  ...
  private static class ODSAppValueWithTagsStandardSchemeFactory implements SchemeFactory {
    public ODSAppValueWithTagsStandardScheme getScheme() {
      return new ODSAppValueWithTagsStandardScheme();
    }
  }

  private static class ODSAppValueWithTagsStandardScheme extends StandardScheme<ODSAppValueWithTags> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ODSAppValueWithTags struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tags = new ArrayList<AggSettings>(_list24.size);
                AggSettings _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new AggSettings();
                  _elem25.read(iprot);
                  struct.tags.add(_elem25);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ODSAppValueWithTags struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.tags != null) {
        oprot.writeFieldBegin(TAGS_FIELD_DESC);
        {
          ...
          for (AggSettings _iter27 : struct.tags)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class ODSAppValueWithTagsTupleSchemeFactory implements SchemeFactory {
    public ODSAppValueWithTagsTupleScheme getScheme() {
      return new ODSAppValueWithTagsTupleScheme();
    }
  }

  private static class ODSAppValueWithTagsTupleScheme extends TupleScheme<ODSAppValueWithTags> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ODSAppValueWithTags struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetTags()) {
        {
          ...
          for (AggSettings _iter28 : struct.tags)
          {
            _iter28.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ODSAppValueWithTags struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.tags = new ArrayList<AggSettings>(_list29.size);
          AggSettings _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new AggSettings();
            _elem30.read(iprot);
            struct.tags.add(_elem30);
          }
        }
        struct.setTagsIsSet(true);
      }
