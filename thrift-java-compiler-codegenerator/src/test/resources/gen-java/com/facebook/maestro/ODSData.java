...
public class ODSData implements org.apache.thrift.TBase<ODSData, ODSData._Fields>, java.io.Serializable, Cloneable, Comparable<ODSData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ODSData");
  ...
  static {
    schemes.put(StandardScheme.class, new ODSDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ODSDataTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ODSData.class, metaDataMap);
  }
  ...
  public ODSData deepCopy() {
    return new ODSData(this);
  }
  ...
  public ODSData setUnixTime(long unixTime) {
    this.unixTime = unixTime;
    setUnixTimeIsSet(true);
    return this;
  }
  ...
  public ODSData setValue(String value) {
    this.value = value;
    return this;
  }
  ...
  public ODSData setEntity(String entity) {
    this.entity = entity;
    return this;
  }
  ...
  public ODSData setKey(String key) {
    this.key = key;
    return this;
  }
   ...
   * @see OdsDataType
   */
  public ODSData setDataType(OdsDataType dataType) {
    this.dataType = dataType;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ODSData)
      return this.equals((ODSData)that);
    return false;
  }

  public boolean equals(ODSData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ODSData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ODSData(");
    boolean first = true;
  ...
  private static class ODSDataStandardSchemeFactory implements SchemeFactory {
    public ODSDataStandardScheme getScheme() {
      return new ODSDataStandardScheme();
    }
  }

  private static class ODSDataStandardScheme extends StandardScheme<ODSData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ODSData struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ODSData struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ODSDataTupleSchemeFactory implements SchemeFactory {
    public ODSDataTupleScheme getScheme() {
      return new ODSDataTupleScheme();
    }
  }

  private static class ODSDataTupleScheme extends TupleScheme<ODSData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ODSData struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ODSData struct) throws org.apache.thrift.TException {
